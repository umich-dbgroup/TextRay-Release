...
if __name__ == '__main__':
    ...
    SUB2_CANDIDATES_DIR = os.path.join(PREFIX, "rewards/dev/sub2")
    RUNNING_DIR = '/z/zxycarol/ComplexWebQuestions_Resources/label_prior_dev_test/CONSTrue_OPTadam_LR0.0005_GA0.5_ATTNTrue100_DO0.0_PRFalse/5'
    FLAT_FILE_PATH1 = os.path.join(RUNNING_DIR, "sub1_lookup.csv")
    FLAT_FILE_PATH2 = os.path.join(RUNNING_DIR, "sub2_lookup.csv")
    SUB2_PREDS_PATH = os.path.join(RUNNING_DIR, "qid_to_sub2_res.json")
    ...
    # test_interface.get_average_f1(FINAL_RESULTS_PATH)
