...
CLUSTER_DATA_SRC = os.path.join(DATA_PREFIX, "stanfordie", "cluster", SPLIT + "_0.3.json")

CLUSTER_DATA_SRC_FILES = [os.path.join(DATA_PREFIX, "stanfordie", "cluster", "dev_0.3.json"),
                          os.path.join(DATA_PREFIX, "stanfordie", "cluster", "train_0.3.json"),
                          os.path.join(DATA_PREFIX, "stanfordie", "cluster", "test_0.3.json")]
ALL_CLUSTER_DATA_SRC = os.path.join(DATA_PREFIX, "stanfordie", "cluster", "all_0.3.json")
